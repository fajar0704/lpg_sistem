...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('admin.sales.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">+ Penjualan Baru</a>
</div>
        ...
        <table class="w-full min-w-max">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-sm text-gray-900">{{ ucfirst($sale->sold_by) }}</td>
                    <td class="px-4 py-3 text-sm">
                        <a href="{{ route('admin.sales.show', $sale) }}" class="text-blue-600 hover:underline">Detail</a>
                    </td>
                </tr>
                @empty
                <tr><td colspan="7" class="px-4 py-4 text-center text-gray-500">Belum ada data penjualan</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
