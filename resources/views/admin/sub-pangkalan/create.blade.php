...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 mt-2">Tambah Sub Pangkalan</h2>
</div>

<div class="bg-white p-6 rounded-lg shadow max-w-2xl">
    <form action="{{ route('admin.sub-pangkalan.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="text" name="nama_ktp" id="nama_ktp" value="{{ old('nama_ktp') }}" 
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alamat_ktp" id="alamat_ktp" rows="2" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('alamat_ktp') border-red-500 @enderror" required>{{ old('alamat_ktp') }}</textarea>
                @error('alamat_ktp')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="mb-6">
            ...
            <select name="role" id="role" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100" readonly>
        ...
        <div class="mb-6">
            <div class="flex flex-col items-center gap-3">
                <video id="camera-video" width="320" height="240" autoplay class="border rounded-lg bg-gray-200 object-cover"></video>
        ...
        <script>
            ...
            snapBtn.addEventListener('click', () => {
                ...
                // Optional: stop camera to save battery
                if(stream) {
